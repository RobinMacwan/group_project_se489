...
class DataIngestion:
    ...
    def download_file(self) -> str:
        ...
        try:
            ...
            zip_download_dir = str(self.config.local_data_file)  # Ensure this is a string for mypy
            ...
            return zip_download_dir  # Return the path to the downloaded file, fix mypy error
